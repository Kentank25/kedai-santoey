...
const fullMenu = [
  // MAKANAN
  { id: 1, category: "Makanan", title: "Sop iga", price: "18K", image: "https://images.unsplash.com/photo-1547592180-85f173990554?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Sop iga sapi hangat berkuah gurih kaya rempah khas Kedai Santoey." },
  ...
  { id: 3, category: "Makanan", title: "Ns daun jeruk ayam", price: "20K", image: "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Nasi wangi daun jeruk yang sedap disajikan dengan ayam goreng bumbu spesial." },
  { id: 4, category: "Makanan", title: "Nasi goreng telor", price: "17K", image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Nasi goreng bumbu tradisional dengan telur mata sapi/dadar khas kaki lima." },
  ...
  // MINUMAN
  { id: 6, category: "Minuman", title: "Kopi seduh sachet", price: "5K", image: "https://images.unsplash.com/photo-1559525839-b184a4d698c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Aneka pilihan kopi sachet instan panas diseduh langsung." },
  { id: 7, category: "Minuman", title: "Jus Jeruk H/C", price: "10K", image: "https://images.unsplash.com/photo-1600271886742-f049cd451bba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Jus jeruk segar diperas murni, disajikan hangat atau dengan es batu." },
  ...
  { id: 14, category: "Penutup", title: "Aneka cemilan", price: "2-12K", image: "https://images.unsplash.com/photo-1599490659213-e2b9527bd087?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Koleksi cemilan ringan di rak kayu kasir mulai dari keripik hingga jajanan pasar." },

  // KOPI DAN TEH
  { id: 15, category: "Kopi & Teh", title: "Americano H/C", price: "10K", image: "https://images.unsplash.com/photo-1551030173-122aabc4489c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Seduhan biji kopi arabika pilihan tanpa gula khas WFC." },
  ...
  { id: 19, category: "Kopi & Teh", title: "Aren", price: "15K", image: "https://images.unsplash.com/photo-1558401391-7899b4bd5bbf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Kopi susu gula aren bestseller Kedai Santoey, manis gurih nagih." },
  ...
  { id: 30, category: "Camilan", title: "Cuankie KS", price: "16K", image: "https://images.unsplash.com/photo-1599490659213-e2b9527bd087?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Cuankie gurih hangat spesial Kedai Santoey isi siomay, tahu, dan bakso." },
  ...
  { id: 32, category: "Camilan", title: "Gorengan paket", price: "6K", image: "https://images.unsplash.com/photo-1599490659213-e2b9527bd087?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", desc: "Paket gorengan tahu/tempe/bakwan hangat cocol sambal kecap." },
...
const categories = ["Paket Hemat", "Makanan", "Mie", "Camilan", "Kopi & Teh", "Minuman", "Penutup"];

export default function MenuHighlight() {
  const [activeTab, setActiveTab] = useState("Paket Hemat");
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredMenu.length === 0 ? (
              <div className="py-16 px-6 text-center bg-white/40 backdrop-blur-md rounded-3xl border border-white/50 shadow-sm max-w-xl mx-auto space-y-5">
                ...
                <p className="text-base text-santoey-brown/70 leading-relaxed max-w-md mx-auto">
                  Menu Paket Hemat Kelompok & Organisasi sedang kami persiapkan khusus untuk sesi nugas kelompok yang lebih hemat. Tunggu tanggal mainnya ya!
                </p>
                <div className="pt-2">
